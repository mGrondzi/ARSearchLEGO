...
public class ModelTrackerTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    private bool modelTracking = false;
        ...
        TrackableBehaviour.Status newStatus)
    {
        if ((newStatus == TrackableBehaviour.Status.DETECTED ||
                ...
                newStatus == TrackableBehaviour.Status.EXTENDED_TRACKED) && activateTracking && modelTracking)
        {
    ...
    public void toogleModelTracking(bool enable)
    {
        this.modelTracking = enable;
    }
}
